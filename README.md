...
| 일정표 OCR 기능 | 건강 모니터링 대시보드 | AI 주간 리포트 자동 생성 | 음성 기반 일지 작성 | 건강 상태 측정 기능 |
| :-------------: | :--------------------: | :-----------------------: | :------------------: | :------------------: |
| <img src="./ocr.gif" height="200"> | <img src="./건강추이.gif" height="200"> | <img src="./리포트.gif" height="200"> | <img src="./STT.gif" height="200"> | <img src="./측정.gif" height="200"> |
