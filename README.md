...
### 1️⃣ 일정표 OCR & 건강 모니터링 대시보드

| 일정표 OCR 기능 | 건강 모니터링 대시보드 |
| :-------------: | :--------------------: |
| <img src="./ocr.gif" height="300"> | <img src="./건강추이.gif" height="300"> |

---

### 2️⃣ AI 리포트 생성 & 음성 일지 작성

| AI 주간 리포트 자동 생성 | 음성 기반 일지 작성 |
| :-----------------------: | :------------------: |
| <img src="./리포트.gif" height="300"> | <img src="./STT.gif" height="300"> |
