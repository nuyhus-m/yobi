...
//            @AuthenticationPrincipal CustomUserDetail userDetail,
        ...
        ApiResult result = measureService.saveBaseElement(userId, requestDTO);
        ...
        URI location = URI.create("/base/" + userId);
...
//            @AuthenticationPrincipal CustomUserDetail userDetail,
        ...
        ApiResult result = measureService.saveHeartRate(userId, requestDTO);
        ...
        URI location = URI.create("/heart-rate/" + userId);
        return ResponseEntity.created(location).build();
    }
...
//            @AuthenticationPrincipal CustomUserDetail userDetail,
        ...
        ApiResult result = measureService.saveStress(userId, requestDTO);
        if(result instanceof ApiResponseDTO<?> errorResult){
            String code = errorResult.getCode();
            HttpStatus status = ApiResponseCode.fromCode(code).getHttpStatus();
            ResponseEntity.status(status).body(errorResult);
        ...
        URI location = URI.create("/stress/" + userId);
        return ResponseEntity.created(location).build();
    }
...
//            @AuthenticationPrincipal CustomUserDetail userDetail,
        ...
        ApiResult result = measureService.saveTemperature(userId, requestDTO);
        if(result instanceof ApiResponseDTO<?> errorResult){
            String code = errorResult.getCode();
            HttpStatus status = ApiResponseCode.fromCode(code).getHttpStatus();
            ResponseEntity.status(status).body(errorResult);
        ...
        URI location = URI.create("/temperature/" + userId);
        return ResponseEntity.created(location).build();
    }
...
//            @AuthenticationPrincipal CustomUserDetail userDetail,
        ...
        ApiResult result = measureService.saveBodyComposition(userId, requestDTO);
        if(result instanceof ApiResponseDTO<?> errorResult){
            String code = errorResult.getCode();
            HttpStatus status = ApiResponseCode.fromCode(code).getHttpStatus();
            ResponseEntity.status(status).body(errorResult);
        ...
        URI location = URI.create("/body/" + userId);
        return ResponseEntity.created(location).build();
    }
...
//            @AuthenticationPrincipal CustomUserDetail userDetail,
        ...
        ApiResult result = measureService.saveBloodPressure(userId, requestDTO);
        if(result instanceof ApiResponseDTO<?> errorResult){
            String code = errorResult.getCode();
            HttpStatus status = ApiResponseCode.fromCode(code).getHttpStatus();
            ResponseEntity.status(status).body(errorResult);
        ...
        URI location = URI.create("/blood-pressure/" + userId);
        return ResponseEntity.created(location).build();
    }
